 ...
 * @author ARANGO
 */
public class BDetalleVariedadCalibre {
    ...
    private String estadovariedadV;
    ...
    public String getEstadovariedadV() {
        return estadovariedadV;
    }

    public void setEstadovariedadV(String estadovariedadV) {
        this.estadovariedadV = estadovariedadV;
    }
